...
# =============================================================================
    ...
    for step, x_batch_train in enumerate(train_image_ds):
        ...
        ##consider every 5000 elements as one epoch
        if ((step+1)*batch_size)%1000 ==0:
            ...
            with summary_writer.as_default():
                tf.summary.scalar('loss', loss_metric.result(), step=int(ckpt.step))
            ...
            with summary_writer.as_default():
                tf.summary.scalar('val_loss', loss_metric.result(), step=int(ckpt.step))
